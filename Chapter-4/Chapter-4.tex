...
When applied to three dimensional jet flow simulation, this method is demonstrated to introduce less overall dissipation than GSPH.
...
\end{eqnarray}
[Aside: \citet{cha2003implementations} proposed a second order accurate GSPH method by using
