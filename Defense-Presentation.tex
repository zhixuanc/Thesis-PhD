...
\begin{figure}
\flushleft
\includegraphics[width=0.385\textwidth]{./Chapter-5/Figures/SFC_particles_buckets}
\hfill
\includegraphics[width=0.415\textwidth]{./Chapter-5/Figures/SFC_particles_buckets_partition}
\end{figure}
\end{frame}
...
\resizebox{0.70 \textwidth}{!}{
  ...
  \end{tabular}}
\begin{figure}
\includegraphics[width=0.70\textwidth]  {./Chapter-5/Figures/adj_vs_no}
\end{figure}
\end{minipage}
%
\end{figure}
