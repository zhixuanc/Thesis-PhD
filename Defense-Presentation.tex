...
\date [07-05-2018] {Ph.D. Dissertation Defence}
...
\begin{minipage}{.480\linewidth} 
  ...
  flashvars={source=./Movies/No_purterbation-from-sml-of-bc.mp4 &loop=true}]
  {}{VPlayer.swf}
\end{minipage}
\hfill
\begin{minipage}{.480\linewidth} 
...
\begin{itemize}
\item Density varies in a large range in compressible flow
\item The atmosphere is stratified, different phases have different density, so need unequal particle mass
\end{itemize}
Leading to $h$ varying in a larger range so non-uniformly distributed.
\end{frame}
...
\end{minipage}
\footnotetext [5]{Evrard, August E, ``Beyond N-body: 3D cosmological gas dynamics"}
\footnotetext [6]{Hernquist et al, ``TREESPH-A unification of SPH with the hierarchical tree method"}
\footnotetext [7]{Inutsuka, Shu-ichiro, ``Reformulation of smoothed particle hydrodynamics with Riemann solver"}
\end{frame}
...
\end{figure}
\begin{figure}
\includegraphics[width=0.245\textwidth]{./Chapter-6/Figures/conc_along_axis}
\hfill
\includegraphics[width=0.245\textwidth]{./Chapter-6/Figures/conc_cross}
\hfill
\includegraphics[width=0.245\textwidth]{./Chapter-6/Figures/velo_along_axis}
\hfill
\includegraphics[width=0.245\textwidth]{./Chapter-6/Figures/vel_cross}
\end{figure}
\end{frame}
...
\begin{figure}
\flushleft
\includegraphics[width=0.30\textwidth]{./Chapter-6/Figures/radius_strong}
\hfill
\includegraphics[width=0.30\textwidth]{./Chapter-6/Figures/Temp}
\hfill
\includegraphics[width=0.30\textwidth]{./Chapter-6/Figures/density_strong}
\end{figure}
\begin{figure}
\includegraphics[width=0.818 \textwidth]{./Chapter-6/Figures/msfrac}
\end{figure}
\end{frame}
...
%  
  \mediabutton[
  mediacommand=vidH:playPause,
  mediacommand=vidI:playPause,
]{\fbox{Play/Pause}}
%
\end{frame}
...
%  
  ...
  mediacommand=vidG:playPause,
]{\fbox{Play/Pause}}
%
\end{frame}

\begin{frame}{Umbrella}
The Plume-SPH solver is not only used for plume model. By assigning proper initial condition and boudary condition, it can also be used for umbrella simulation. Of course, the physics might not be valid.
  \includemedia[
  label=vidJ,
  ...
  activate=onclick,
  deactivate=onclick,
  addresource=./Movies/Cut-view-Mssfrc-umbrella.mp4,
  flashvars={source=./Movies/Cut-view-Mssfrc-umbrella.mp4 &loop=true}]
  {}{VPlayer.swf}
%  
  \mediabutton[
  mediacommand=vidJ:playPause,
]{\fbox{Play/Pause}}
%
\end{frame}
...
\begin{figure}[!htb]
    ...
    \begin{minipage}{.288\textwidth}
        \centering
        \includegraphics[width=0.90 \textwidth]{./Chapter-7/Figures/OB-ash-23hr-ash}
    \end{minipage}% 
    \\
        \begin{minipage}{.288\textwidth}
        \centering
    ...
    \begin{minipage}{.288\textwidth}
        \centering
        \includegraphics[width=0.90 \textwidth]{./Chapter-7/Figures/OB-ash-31hr-ash}
    \end{minipage}% 
    \\
        \begin{minipage}{.288\textwidth}
        \centering
    ...
    \begin{minipage}{.288\textwidth}
        \centering
        \includegraphics[width=0.90 \textwidth]{./Chapter-7/Figures/OB-ash-55hr-ash}
    \end{minipage}% 
\end{figure}
\end{frame}
%----------------------------------------------------------------------------
